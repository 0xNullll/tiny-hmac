...
#define ENABLE_SHAKE128 0      /* enable SHAKE128 by default */
#endif

#ifndef ENABLE_SHAKE256
#define ENABLE_SHAKE256 0      /* enable SHAKE256 by default */
#endif

#ifndef ENABLE_RAWSHAKE128
#define ENABLE_RAWSHAKE128 0   /* enable RawSHAKE128 by default */
#endif

#ifndef ENABLE_RAWSHAKE256
#define ENABLE_RAWSHAKE256 0   /* enable RawSHAKE256 by default */
#endif
 ...
 * ------------------------------------------------------------------ */
FORCE_INLINE int TSHASH_FN(ConstTimeCompare)(const uint8_t *a, const uint8_t *b, size_t len) {
    if (!a || !b) return 0;
    if (len == 0) return 1;
...
FORCE_INLINE int SHA1CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA256CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA224CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA512CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA384CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA512_224CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA512_256CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int KeccakCompareOrder(const uint8_t *a, const uint8_t *b, size_t len) {
...
FORCE_INLINE int SHA3_224CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA3_256CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA3_384CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHA3_512CompareOrder(const uint8_t *a, const uint8_t *b) {
...
FORCE_INLINE int SHAKE128CompareOrder(const uint8_t *a, const uint8_t *b, size_t len) {
    return TSHASH_FN(ConstTimeCompare)(a, b, len);
...
FORCE_INLINE int SHAKE256CompareOrder(const uint8_t *a, const uint8_t *b, size_t len) {
    return TSHASH_FN(ConstTimeCompare)(a, b, len);
}
#endif
...
FORCE_INLINE int RawSHAKE128CompareOrder(const uint8_t *a, const uint8_t *b, size_t len) {
    return TSHASH_FN(ConstTimeCompare)(a, b, len);
}
#endif
...
FORCE_INLINE int RawSHAKE256CompareOrder(const uint8_t *a, const uint8_t *b, size_t len) {
    return TSHASH_FN(ConstTimeCompare)(a, b, len);
}
#endif
