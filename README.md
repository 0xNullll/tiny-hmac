...
It builds on **[Tiny SHA](tiny-sha/)** — also available as a standalone project at  
https://github.com/0xNullll/tiny-sha — and allows optional direct use of Tiny SHA functions.
